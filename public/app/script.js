...
const DEFAULTS = {
  ...
  info: [
    ...
    { key: "height", label: "Height", icon: "fa-ruler-vertical", value: "191 cm" },
    { key: "weight", label: "Weight", icon: "fa-weight-hanging", value: "91 kg" },
    { key: "age", label: "Age", icon: "fa-cake-candles", value: "26 years" },
    { key: "foot", label: "Strong Foot", icon: "fa-shoe-prints", value: "Right" },
    { key: "wfAcc", label: "WF Accuracy", icon: "fa-crosshairs", value: "Medium" },
  ...
  progression: [
    ...
    { key: "dribbling", name: "Dribbling", icon: "fa-shoe-prints", value: 0 },
    { key: "dexterity", name: "Dexterity", icon: "fa-right-left", value: 4 },
    { key: "lower", name: "Lower Body Strength", icon: "fa-person-running", value: 6 },
    { key: "aerial", name: "Aerial Strength", icon: "fa-angles-up", value: 8 },
    { key: "defending", name: "Defending", icon: "fa-shield-halved", value: 14 },
  ...
  stats: {
    ...
    DEFENDING: [
      ["Defensive Awareness", 101, "+5"],
      ["Tackling", 102, "+5"],
      ["Aggression", 98, ""],
      ["Defensive Engagement", 100, "+1"],
      ["GK Awareness", 41, ""],
      ["GK Catching", 41, ""],
      ["GK Parrying", 41, ""],
      ["GK Reflexes", 41, ""],
  ...
  inbuiltSpecial: ["Long Reach Tackle", "Aerial Fort"],
